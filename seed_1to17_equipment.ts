...
async function main() {
  ...
  console.log('Seeding 1-17 Equipment Data (Granular Holzwerkstatt)...');
  ...
  async function addEquipment(
    ...
    const category = await prisma.equipmentCategory.create({ data: { title: catName } });
  ...
  await prisma.equipmentBudget.create({ data: { totalAmount: 60886.46 } });
